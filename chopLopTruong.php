                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-3">
                                ...
                                <li class="breadcrumb-item active fw-light" aria-current="page">Chọn lớp trưởng</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h3 class="h4 mb-0">Chọn lớp trưởng</h3>
                                </div>
                                <div class="card-body">
                                                ...
                                                case 'Chọn làm lớp trưởng': {
                                                        ...
                                                        if (isset($layid)) {
                                                            if ($layid > 0) {
                                                                ...
                                                                echo 'bạn chưa chọn lớp trưởng';
                                                            }
                                                        }
                                                    }
                                                    break;
                                                case 'Thu hồi quyền lớp trưởng': {
                                                        if (isset($layid)) {
                                                            if ($layid > 0) {
                                                                if ($p->themxoasua("UPDATE taikhoan SET phanquyen = '2' WHERE idSV = '$layid'") == 1) {

                                                                    echo 'thu hồi quyền thành công.';
                                                                } else {
                                                                    echo 'thu hồi thất bại.';
                                                                }
                                                            }
                                                        }
                                                    }
                            ...
                            <div class="col-lg-12">
                                <div class="card mb-0">
                                    <div class="card-header">
                                        ...
                                        <h3 class="h4 mb-0">Danh sách sinh viên đã được chọn làm lớp trưởng:</h3>
                                        <?php
