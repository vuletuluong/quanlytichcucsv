          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page">Danh sách lớp học phần</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div class="col-lg-12">
                <div class="card mb-0">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Danh sách lớp học phần</h3>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <?php
                      $p->load_ds_lhp("SELECT maLHP,tenLHP,Thoigianhoc,Tenphonghoc FROM `lophocphan` WHERE 1")
                      ?>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-12">
                <div class="card mb-0">
                  <div class="card-header">
                    ...
                    <div class="row">
                      <h3 class="h4 mb-0 col-lg-6">Danh sách sinh viên lớp
                        <?php echo $p->laycot("select tenLHP from lophocphan where maLHP='$idlop'") ?></h3>
                      
                        <form id="form1" name="form1" method="post" action="" class="col-lg-6">
                          <label for="txtnhap"><h3 class="h4 mb-0 ">Nhập sinh viên cần tìm </h3></label>
                          <input type="text" name="txtnhap" id="txtnhap" />
                          <input type="submit" name="txttk" id="txttk" value="Search" />
                        </form>
                        <?php
                          ...
                          switch ($_POST['txttk']) {
                            case 'Search': {
                                ...
                                if ($s < 0) {
                                  ...
                                  $p->loaddssvlop("select ID,TenSV from sinhvien where TenSV LIKE '%$s%' order by ID desc");
                                }
                              }
                              break;
                          }
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      $sql = "SELECT ID,TenSV FROM `sinhvien` WHERE MaLHP='$idlop'";
                      $p->loaddssvlop($sql);
