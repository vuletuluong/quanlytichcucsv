                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-3">
                                ...
                                <li class="breadcrumb-item active fw-light" aria-current="page">Tạo pass điểm danh</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h3 class="h4 mb-0">Tạo mật khẩu điểm danh</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="" class="form-horizontal" >
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="txtpass" type="text" class="form-control" id="txtpass">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9 ms-auto mt-4">
                                                ...
                                                <input name="nut" type="submit"  class="btn btn-primary" id="nut" value="Tạo mật khẩu">
                                            </div>
                                        </div>
                     <?php
                           		 ...
                           		 case 'Tạo mật khẩu': 
								 {
                                    ...
                                    if ($matkhaudiemdanh != ''){
                                        if ($p->themxoasua($sql) == 1) {
                                            echo 'Mật khẩu khởi tạo thành công có hiệu lực trong 2 phút!!';
                                        } else {
