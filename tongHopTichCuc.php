            ...
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 py-3">
                  ...
                  <li class="breadcrumb-item active fw-light" aria-current="page">Danh sách hoạt động ngoại khóa</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="card mb-0">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                         <?php 
					  	$p->load_ds_lhptonghop("SELECT maLHP,tenLHP,Thoigianhoc,Tenphonghoc FROM `lophocphan` WHERE 1")
					  ?>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-12">
                    <div class="card mb-0">
                      <div class="card-header">
                        ...
                        <h3 class="h4 mb-0">Danh sách sinh viên lớp <?php echo $p->laycot("select tenLHP from lophocphan where maLHP='$idlhp'") ?> </h3>
                      </div>
                      <div class="card-body">
                        <div class="table-responsive">
                           ...
                           <?php
							 ...
							 $p->load_quanli_tichcuc("select idSV,tenSV,number_HDNK,solanPhatBieu from bangdiemtichcuc where MaLHP='$idlhp'");
					  ...
					  ?>
                        ...
                        <div class="table-responsive">
                           ...
                           <?php
							 ...
							 $sql2="SELECT tesv,masv, COUNT( trangthai ) AS sobuoi FROM `phieudiemdanh` where malhp='$idlhp' GROUP BY( masv)";
									$a->loaddiemdanhki($sql2);
