                ...
                <ul class="list-unstyled py-4">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="#exampledropdownDropdownm"
                        ...
                        <ul class="collapse list-unstyled " id="exampledropdownDropdownm">
                            ...
                            <li><a class="sidebar-link" href="danhDau.html">Đánh dấu số lần phát biểu</a></li>
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-3">
                                ...
                                <li class="breadcrumb-item active fw-light" aria-current="page">Thông tin cá nhân</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card mb-0">
                                    <div class="card-header">
                                        ...
                                        <h3 class="h4 mb-0">Thông tin cá nhân</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <?php 
												...
												$a->load_ds_sinhvien("select * from sinhvien where ID='$idsv'");
                        ...
                        <div class="col-lg-12">
                          <div class="card">
                            <div class="card-header">
                              ...
                              <h3 class="h4 mb-0">Thay đổi thông tin cá nhân</h3>
                            </div>
                            <div class="card-body">
                              <form class="form-horizontal">
                                ...
                                <div class="border-bottom my-5 border-gray-200"></div>
                                <div class="row">
                                  <label class="col-sm-3 form-label">SĐT</label>
                                  <div class="col-sm-9">
                                ...
                                <div class="border-bottom my-5 border-gray-200"></div>
                                <div class="row">
                                    <label class="col-sm-3 form-label">Avatar</label>
                                    <div class="col-sm-9">
