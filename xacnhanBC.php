                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-3">
                                ...
                                <li class="breadcrumb-item active fw-light" aria-current="page">Xác nhận báo cáo</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                          <div class="card mb-0">
                            <div class="card-header">
                              ...
                              <h3 class="h4 mb-0">Danh sách sinh viên báo cáo</h3>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h3 class="h4 mb-0">Xác nhận báo cáo</h3>
                                    </div>
                                    <div class="card-body">
                                        
                                        <form method="post" id="myform" action="">
                                            <div class="mb-3">
                                                <label class="form-label" for="exampleInputEmail1">Tên báo cáo</label>
                                          ...
                                          <div class="mb-3">
                                            <label class="form-label" for="exampleInputPassword1">Nội dung</label>
                                          ...
                                          <div class="mb-3">
                                                <label class="form-label" for="exampleInputPassword1">ID sinh viên</label>
                                            	...
                                            	<input name="nut" type="submit" class="btn btn-primary" id="nut" value="Xác nhận">
                                                <input name="nut" type="submit" class="btn btn-primary" id="nut" value="Không xác nhận">
...
switch($_POST['nut'])
{
	case'Xác nhận':
	{
		...
		if($kt_id==$id){
			...
			{
				echo 'Đã cập nhật số lần tham gia HDNK.';
			}else
			{
				echo 'Chưa cập nhật số lần tham gia.';
			}
		}
		else{
			...
			{
				echo 'Đã thêm số lần tham gia hoạt động ngoại khóa.';
			}
			else{
				echo 'Thêm thất bại ';
			}
