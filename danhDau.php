            ...
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 py-3">
                  ...
                  <li class="breadcrumb-item active fw-light" aria-current="page">Đánh dấu số lần phát biểu</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="card mb-0">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                                ...
                                <div class="row">
                                  <label class="col-sm-3 form-label">Mã số sinh viên</label>
                                  <div class="col-sm-9">
                                ...
                                <div class="row">
                                  <div class="col-sm-9 ms-auto">
                                    ...
                                    <input name="nut" type="submit" class="btn btn-primary" id="nut" value="đánh dấu">
                                  </div>
                                </div>
                                <?php
