          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page">Điểm danh</li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="card-body">
                  <form action="#" method="post" class="form-horizontal" id="myform">
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                        <input name="passdiemdanh" type="text" class="form-control" id="passdiemdanh">
                      </div>
                    </div>

                    <div class="row">
                      <div class="col-sm-9 ms-auto mt-4">
                        <input name="nut" type="submit" class="btn btn-primary" id="nut" value="Nhập">
                          ...
                          switch ($_POST['nut']) {
                            case 'Nhập': {
								...
								if(!isset($_COOKIE['hung'])){
									header("location:not_diemdanh.php");
