      ...
      <div class="content-inner w-100">
          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page">Thêm lớp học phần</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Tạo lớp học phần</h3>
                  </div>
                  <div class="card-body">
                    <form action="" method="post" class="form-horizontal"  >
                      <div class="row">
                        <label class="col-sm-3 form-label">Tên lớp học phần</label>
                        <div class="col-sm-9">
                          <input name="tenlhp" class="form-control"   type="text">
                        </div>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label  class="col-sm-3 form-label">Thời gian học</label>
                        <div class="col-sm-9">
                          <input name="thoigianhoc" type="text" class="form-control" id="thoigianhoc">
                        </div>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">Tên phòng học</label>
                        <div class="col-sm-9">
                          <input name="tenphonghoc" type="text" class="form-control" id="tenphonghoc">
                        </div>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">Nhập năm học</label>
                        <div class="col-sm-9">
                          <input name="namhoc" type="text"  class="form-control" id="namhoc">
                        </div>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">Nhập thời gian</label>
                        <div class="col-sm-9">
                          <input name="thoigian" type="text" class="form-control" id="thoigian">
                        </div>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
		...
		switch($_POST['nut'])
		{
			case'Save changes':
			{
				...
				$tenlhp=$_REQUEST['tenlhp'];
				$thoigianhoc=$_REQUEST['thoigianhoc'];
				$tenphonghoc=$_REQUEST['tenphonghoc'];
				$namhoc=$_REQUEST['namhoc'];
				$thoigian=$_REQUEST['thoigian'];
                if( $tenlhp && $thoigianhoc && $tenphonghoc && $namhoc && $thoigian !='')

						if($p->themxoasua("INSERT INTO lophocphan(tenLHP,Thoigianhoc,Tenphonghoc,Namhoc,Thoigian) VALUES(' $tenlhp', '$thoigianhoc', '$tenphonghoc','$namhoc','$thoigian')")==1)
						{
							echo'Thêm lớp học phần thành công.';
						}
						else
						{
							echo'thêm lớp học phần không thành công.';
						}
                else
                {
