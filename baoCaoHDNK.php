          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page"> Báo cáo hoạt động ngoại khóa</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div class="col-lg-12">
                <div class="card mb-0">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Danh sách hoạt động ngoại khóa đã đăng kí</h3>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Nội dung báo cáo hoạt động ngoại khóa</h3>
                  </div>
                  <div class="card-body">
                    <form method="post" enctype="multipart/form-data" class="form-horizontal" id="myform">
                      ...
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">Tên file báo cáo</label>
                        <div class="col-sm-9">
                      ...
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">Nội dung file</label>
                        <div class="col-sm-9">
                      ...
                      <div class="row">
                        <div class="col-sm-9 ms-auto">
                          ...
                          <input name="nut" type="submit" class="btn btn-primary" id="nut" value="Tải lên">
                        </div>
                      </div>
                      </form>
<?php
              ...
              <div class="col-lg-12">
                <div class="card mb-0">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Danh sách hoạt động ngoại khóa đã nộp</h3>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <?php
