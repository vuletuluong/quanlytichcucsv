        ...
        <div class="page-content d-flex align-items-stretch">
            ...
            <nav class="side-navbar z-index-40">
                ...
                <ul class="list-unstyled py-4">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="#exampledropdownDropdownm"
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-3">
                                <li class="breadcrumb-item"><a class="fw-light" href="homeSV.html">Trang chủ</a></li>
                                <li class="breadcrumb-item active fw-light" aria-current="page">Xem điểm tích cực
                                </li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><?php echo $_SESSION['tensv'];  ?></th>
                                                        <td><input type="text" value="<?php echo $p->laycot("select number_HDNK from bangdiemtichcuc where idSV='$idsv'limit 1 "); ?>" ></td>
                                                        <td><input type="text" value="<?php echo $p->laycot("select solanPhatBieu from bangdiemtichcuc where idSV='$idsv' limit 1 "); ?>"></td>	
                                                        <td><input type="text" value="<?php $sql="SELECT COUNT(trangthai) FROM phieudiemdanh WHERE trangthai='present' AND masv='$idsv'";
